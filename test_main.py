...
def test_obtain_drinks_success():
    """
    Test para verificar que la ruta /menu devuelve correctamente la lista de bebidas registradas en la base de datos.
    """
    ...
    # Hacer una petición GET a la ruta /menu para obtener la lista de bebidas registradas en la base de datos
...
def test_obtain_drink_success():
    """
    Test para verificar que la ruta /menu/{name} devuelve correctamente una bebida específica registrada en la base de datos.
    """
...
def test_obtain_drink_not_found():
    """
    Test para verificar que la ruta /menu/{name} devuelve un error 404 si la bebida no se encuentra en la base de datos.
    """
...
def test_create_drink_success():
    """
    Test para verificar que la ruta /menu crea correctamente una bebida en la base de datos.
    """
    ...
    # Verificar que el status de la respuesta es 200 (OK)
    assert response.status_code == 200
    # Verificar que la bebida creada es la misma que la bebida enviada en la petición, además de obtener el mensaje de éxito
    assert response.json() == {
...
def test_create_drink_empty_name():
    """
    Test para verificar que la ruta /menu devuelve un error 400 si el nombre de la bebida está vacío.
    """
    # Configurar el mock para simular la creación de una bebida
    session.add = MagicMock()
    # Configurar el mock para simular la confirmación de la sesión
...
def test_create_drink_negative_price():
    """
    Test para verificar que la ruta /menu devuelve un error 400 si el precio de la bebida es negativo.
    """
